...
@Component({
  ...
  standalone: true,
  imports: [StarRatingComponent, StarRatingComponent, ButtonComponent, GallerySwiperComponent, GallerySwiperComponent, RouterLink, SizeChartComponent, ProductCardComponent, ZoomComponent, RightDrawerComponent],
